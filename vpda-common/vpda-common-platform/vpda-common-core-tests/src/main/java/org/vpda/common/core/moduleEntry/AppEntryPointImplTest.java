 ...
 *
 */
public class AppEntryPointImplTest {
    ...
    public void testEntryPoint() {
        AppEntryPoint entryPoint = createTestee();
        ...
        List<Class<? extends ModuleEntryPoint>> m = new ArrayList<Class<? extends ModuleEntryPoint>>(1);
        m.add(CommonCoreModuleEntryPoint.class);
        appConf.getRootContainer().addComponent(CommonCoreModuleEntryPoint.class, CommonCoreModuleEntryPointImpl.class);
        ModulesConfiguration modulesConf = new ModulesConfigurationtImpl(appConf, m);
        ...
        assertNotNull(entryPoint.getApplication());

    }

    private AppEntryPoint createTestee() {
        return new AppEntryPointImpl();
    }
