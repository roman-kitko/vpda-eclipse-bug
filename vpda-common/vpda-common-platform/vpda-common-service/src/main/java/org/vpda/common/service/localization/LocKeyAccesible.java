...
/**
 * Any class implemented this interface will publish its localization key
 * 
 * @author kitko
 *
 */
public interface LocKeyAccesible {
    /**
     * 
     * @return key part of loc key
     */
     ...
     * @return locKey
     */
    public abstract LocKey getLocKey();
