 ...
 */
@Immutable
public final class Organization extends AbstractNamedCode implements Serializable, NamedCode, IdentifiedObject<Long> {
     ...
     * @param description
     */
    public Organization(long id, UUID externalId, System system, String code, String name, String description) {
