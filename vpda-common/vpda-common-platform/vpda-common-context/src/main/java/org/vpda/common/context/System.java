...
/**
 * Root system in application
 * 
 * @author admin
 *
 */
@Immutable
public final class System extends AbstractNamedCode implements Serializable, NamedCode, IdentifiedObject<Long> {
     ...
     * @param description
     */
    public System(long id, UUID externalId, String code, String name, String description) {
