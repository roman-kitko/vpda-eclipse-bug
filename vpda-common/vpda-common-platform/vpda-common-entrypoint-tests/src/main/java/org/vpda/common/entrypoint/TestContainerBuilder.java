 ...
 *
 */
public class TestContainerBuilder implements ContainerBuilder {

    @Override
    public PicoContainer buildContainer(PicoContainer parentContainer, Object assemblyScope, boolean addChildToParent) {
        DefaultPicoContainer defaultPicoContainer = new DefaultPicoContainer();
        defaultPicoContainer.addComponent("testKey", "testValue");
