 ...
 *
 */
public class ConcreteProjectTest extends AbstractProjectTest {

    @Override
    protected MuttableApplication createProject() {
        return new ConcreteApplication("TEST", new AppConfigurationImpl());
    }
