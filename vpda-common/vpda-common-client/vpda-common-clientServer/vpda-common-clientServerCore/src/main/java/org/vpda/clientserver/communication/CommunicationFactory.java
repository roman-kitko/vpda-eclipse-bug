...
/**
 * Factory for creating Communications
 * 
 * @author kitko
 *
 */
public interface CommunicationFactory {
     ...
     */
    public Communication createCommunication(CommunicationId communicationId);

    /**
     * 
     * @return Collection of all registered communication
     */
