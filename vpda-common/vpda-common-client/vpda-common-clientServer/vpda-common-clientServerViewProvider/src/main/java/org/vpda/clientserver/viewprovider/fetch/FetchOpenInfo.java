...
/**
 * Information we need to open new fetch
 * 
 * @author kitko
 *
 */
public interface FetchOpenInfo extends ListViewProviderOpenInfo {

    /**
     * @return field that fired fetch
     */
    public String getFetchField();

    /**
     * @return definition of fetch
     */
