...
/**
 * Stateless services for generic view provider
 * 
 * @author kitko
 *
 */
public interface StatelessGenericViewProviderServices extends StatelessViewProviderServices {
    @Override
    public GenericViewProviderInitResponse getProviderInfo(InitStatelessRequest request) throws ViewProviderException;
     ...
     */
    public void submit(SubmitDataRequest request) throws ViewProviderException;
}
