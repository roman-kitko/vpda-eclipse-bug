 ...
 */
package org.vpda.clientserver.viewprovider.dto.inputfactory;
...
public class ClientServerViewProviderDTOInputFactory implements DTORuntimeConfigurationInputFactory {

    @Override
    public DTORuntimeConfigurationInput createInput() {
        return new SingleUnitNameConfigurationInput("viewprovider", ViewProviderDef.class);
    }
