 ...
 *
 */
public class PushButtonACTest extends AbstractButtonACTest {
    ...
    public void testButtonViewProviderComponentImplStringButtonLocValueCommand() {
        PushButtonAC c = new PushButtonAC("test", new PushButtonLocValue("testButton"), DummyCommand.getInstance());
    ...
    protected AbstractButtonAC createTestee() {
        return new PushButtonAC("testButton");
    }

    /**
     * Test loc value class
     */
    public void testLocvalueClass() {
        assertEquals(PushButtonLocValue.class, createTestee().getLocValueClass());
    }
