...
/**
 * Listener support with fire option
 * 
 * @author kitko
 *
 */
public interface MemberListenerSupportWithFireForSingleMember extends MemberListenerSupport {

    /**
     * Fire that environment has changed
     * 
     * @param changeEvent
     */
    ...
    /**
     * Fire that environment has bean initialized
     * 
     * @param initEvent
     */
    ...
    /**
     * Fire that environment structure has changed
     * 
     * @param event
     */
