...
/**
 * Values directly completed by autocomplete
 * 
 * @author kitko
 *
 */
@Immutable
public final class SingleAutoCompletedValues implements Serializable {
     ...
     * @param filledValues
     */
    public SingleAutoCompletedValues(String autoCompleteId, String idField, Map<String, Object> filledValues) {
    ...
    public String toString() {
        return "SingleFetchCompletedValues [autoCompleteId=" + autoCompleteId + ", idField=" + idField + ", filledValues=" + filledValues + "]";
    }
