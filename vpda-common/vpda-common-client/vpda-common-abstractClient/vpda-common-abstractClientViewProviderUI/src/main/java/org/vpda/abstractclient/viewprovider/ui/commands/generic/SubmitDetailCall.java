...
/**
 * Call that will submit detail
 * 
 * @author kitko
 *
 */
public final class SubmitDetailCall extends ReflexiveCall {
     ...
     * @param compsDef
     */
    public SubmitDetailCall(ComponentsGroupsDef compsDef) {
        super(DetailCallsConstants.SUBMIT_DETAIL);
