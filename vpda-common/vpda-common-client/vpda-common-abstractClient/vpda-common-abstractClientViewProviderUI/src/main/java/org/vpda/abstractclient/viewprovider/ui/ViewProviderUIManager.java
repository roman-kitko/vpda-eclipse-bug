...
/**
 * Manager for ui providers
 * 
 * @author kitko
 *
 */
public interface ViewProviderUIManager extends ViewProviderUIRegistry {
    ...
    /**
     * @return ViewProviderComponentsFactory
     */
    public ComponentUIFactory getComponentsFactory();

    /**
     * Create providerUI by kind
     * 
     * @param contextCaller
     * @param openInfo
    ...
    /**
     * Create providerUI by kind and register
     * 
     * @param contextCaller
     * @param openInfo
     * @return ViewProviderUI
    ...
    /**
     * Register provider by its ViewProviderID
     * 
     * @param provider
     */
