 ...
 *
 */
public final class CompleteDetailCompsDefHolderCommandCreator implements ViewProviderUICommandCreator {

    private static final long serialVersionUID = 6636935866165647773L;
    private static CompleteDetailCompsDefHolderCommandCreator instance;
    ...
    public Command createCommand(ViewProviderUI providerUI) {
        ...
        return new CommandCall(new CompleteDetailCall(def));
    }

    /**
     * @return instance of instance
     */
    public synchronized static CompleteDetailCompsDefHolderCommandCreator getInstance() {
        if (instance == null) {
            instance = new CompleteDetailCompsDefHolderCommandCreator();
        }
        return instance;
    }
