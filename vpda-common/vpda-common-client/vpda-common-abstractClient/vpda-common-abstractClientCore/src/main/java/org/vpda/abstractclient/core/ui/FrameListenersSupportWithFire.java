...
/**
 * Listeners support with firing
 * 
 * @author kitko
 *
 */
public interface FrameListenersSupportWithFire extends FrameListenersSupport {
    /**
    ...
    /**
     * Fire before dispose event
     */
    public void fireBeforeDisposed();

    /**
     * Fire after dispose event
     */
