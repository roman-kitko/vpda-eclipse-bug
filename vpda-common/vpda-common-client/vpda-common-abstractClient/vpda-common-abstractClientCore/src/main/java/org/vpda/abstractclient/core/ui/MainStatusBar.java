...
/**
 * Main status off client application
 * 
 * @author kitko
 *
 */
public interface MainStatusBar extends StatusBar {
    /**
     * @param session
     * @param loginInfo
     */
    public void setUserSession(UserSession session, ClientLoginInfo loginInfo);
