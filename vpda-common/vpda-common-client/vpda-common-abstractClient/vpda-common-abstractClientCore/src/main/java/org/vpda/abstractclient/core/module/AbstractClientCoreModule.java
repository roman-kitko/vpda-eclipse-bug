 ...
 */
package org.vpda.abstractclient.core.module;
...
/**
 * 
 * Module for AbstractClientCore
 * 
 * @author kitko
 *
 */
public final class AbstractClientCoreModule extends AbstractModule {
    private static final long serialVersionUID = -1112045280935219431L;
    /** Name of module */
    public final static String MODULE_NAME = "AbstractClientCore";

    /**
     * Constructor for module
     */
    private AbstractClientCoreModule() {
    }
    ...
    public static Module getInstance() {
        return AbstractModule.getModule(AbstractClientCoreModule.class);
    }
